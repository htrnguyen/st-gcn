...
class Processor(IO):
    ...
    def get_parser(add_help=False):
        ...
        parser.add_argument(
            "--start_epoch", type=int, default=0, help="start training from which epoch"
        )
        parser.add_argument(
            "--num_epoch", type=int, default=80, help="stop training in which epoch"
        )
        parser.add_argument(
            "--use_gpu", type=str2bool, default=True, help="use GPUs or not"
        )
        parser.add_argument(
            "--device",
            type=int,
        ...
        parser.add_argument(
            "--save_log", type=str2bool, default=True, help="save logging or not"
        )
        parser.add_argument(
            "--print_log", type=str2bool, default=True, help="print logging or not"
        )
        parser.add_argument(
            "--pavi_log", type=str2bool, default=False, help="logging on pavi or not"
        )
        ...
        parser.add_argument(
            "--debug", action="store_true", help="less data, faster loading"
        )
